...
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || 'TinyAmazon'
export const APP_SLOGAN = process.env. NEXT_PUBLIC_APP_SLOGAN || '=Spend Less, Enjoy More'
export const APP_DESCRIPTION = process.env.NEXT_PUBLIC_APP_DESCRIPTION || "An Amazon Clone build with NextJS"
